			...
			<div class="row align-items-center">
				<div class="col-2">
					<a href="{{url('/')}}" class="brand-wrap mb-0">
						<img alt="#" class="img-fluid" src="https://firebasestorage.googleapis.com/v0/b/foddie-ddd88.appspot.com/o/images%2FWhatsApp%20Image%202023-09-01%20at%206_1693572151683.10?alt=media&token=65db6cfd-e69b-42f3-a910-9ed3e69a0cce" id="logo_web">
					</a>
				</div>
				<div class="col-3 d-flex align-items-center m-none head-search">
					<div class="dropdown ml-4">
						<a class="text-dark dropdown-toggle d-flex align-items-center p-0" href="#" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
							...
							<div><input id="user_locationnew" type="text" size="50" class="pac-target-input"></div>
						</a>
					</div>
				</div>
					...
					<div class="d-flex align-items-center justify-content-end pr-5">
						...
						@else
    						<a href="{{url('login')}}" class="widget-header mr-4 text-dark m-none">
    							<div class="icon d-flex align-items-center"><i class="feather-user h6 mr-2 mb-0"></i> <span>{{trans('lang.signin')}}</span></div>
    						</a>
						@endauth
