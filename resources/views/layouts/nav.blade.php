<nav id="main-nav">
    <ul class="second-nav">
        ...
        @auth
            ...
            <li style="display:none;" class="dine_in_menu dineinrestaurant_tab hide_tab"><a href="{{url('my_dinein')}}"><i class="feather-list mr-2"></i>{{trans('lang.my_dine_in_requests')}}</a></li>
            ...
            <li><a href="{{url('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="feather-user mr-2"></i>{{trans('lang.logout')}}</a></li>
            <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                @csrf
            </form>
            <li><p class="referral_code"></p></li>
        @else
            <li><a href="{{url('contact-us')}}"><i class="feather-user mr-2"></i>{{trans('lang.contact_us')}}</a></li></li>
